...
#define CYBSP_BT_UART_RTS_DRIVEMODE CY_GPIO_DM_ANALOG
...
#define CYBSP_BT_UART_RTS_IRQ ioss_interrupts_gpio_3_IRQn
    ...
    #define CYBSP_BT_UART_RTS_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_BT_UART_RTS_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
#endif //defined (CY_USING_HAL)
